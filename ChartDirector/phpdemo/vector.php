...
$dataX = array(20, 40, 60, 80, 100, 20, 40, 60, 80, 100, 20, 40, 58, 62, 80, 100, 20,
    40, 60, 80, 100, 20, 40, 60, 80, 100);
$dataY = array(20, 20, 20, 20, 20, 40, 40, 40, 40, 40, 60, 60, 60, 60, 60, 60, 80,
    80, 80, 80, 80, 100, 100, 100, 100, 100);

# The lengths (radii) and directions (angles) of the vectors
$dataR = array(6, 6, 9, 6, 6, 6, 9, 12, 9, 6, 9, 12, 12, 12, 12, 9, 6, 9, 12, 9, 6,
    6, 6, 9, 6, 6);
$dataA = array(-45, -30, 0, 30, 45, -60, -45, 0, 45, 60, -90, -90, -90, 90, 90, 90,
...
# set to 11 pixels
$vectorLayerObj = $c->addVectorLayer($dataX, $dataY, $dataR, $dataA, YAxisScale,
    0x0000cc);
