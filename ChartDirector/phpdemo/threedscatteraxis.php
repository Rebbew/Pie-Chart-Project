...
$dataX = array(chartTime(2011, 9, 1), chartTime(2011, 9, 2), chartTime(2011, 9, 3),
    chartTime(2011, 9, 4), chartTime(2011, 9, 5), chartTime(2011, 9, 6), chartTime(
    2011, 9, 7), chartTime(2011, 9, 8), chartTime(2011, 9, 9), chartTime(2011, 9, 10
    ), chartTime(2011, 9, 11));
...
$g0 = $c->addScatterGroup($dataX, $dataY0, $dataZ0, "Alpha Series",
    GlassSphere2Shape, 13, 0xff0000);
...
# dotted drop lines
$g1 = $c->addScatterGroup($dataX, $dataY1, $dataZ1, "Beta Series", Cross2Shape(), 13,
    0x00cc00);
